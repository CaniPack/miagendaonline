...
CREATE TABLE "new_LandingPage" (
    ...
    "videoPosition" TEXT NOT NULL DEFAULT 'header',
...
INSERT INTO "new_LandingPage" ("appointmentDuration", "bingSiteVerification", "bufferTime", "businessType", "buttonText", "calendarDescription", "canonicalUrl", "colorScheme", "contactEmail", "coverImage", "createdAt", "customSchema", "description", "faqs", "focusKeyword", "formFields", "googleAnalyticsId", "googleSiteVerification", "id", "instagram", "isPublished", "logo", "metaDescription", "metaTitle", "professionalName", "profileImage", "requirePayment", "robotsDirective", "seoKeywords", "serviceArea", "services", "showCalendar", "slug", "specializations", "tagline", "title", "updatedAt", "userId", "whatsapp") SELECT "appointmentDuration", "bingSiteVerification", "bufferTime", "businessType", "buttonText", "calendarDescription", "canonicalUrl", "colorScheme", "contactEmail", "coverImage", "createdAt", "customSchema", "description", "faqs", "focusKeyword", "formFields", "googleAnalyticsId", "googleSiteVerification", "id", "instagram", "isPublished", "logo", "metaDescription", "metaTitle", "professionalName", "profileImage", "requirePayment", "robotsDirective", "seoKeywords", "serviceArea", "services", "showCalendar", "slug", "specializations", "tagline", "title", "updatedAt", "userId", "whatsapp" FROM "LandingPage";
