                  ...
                  <div className="h-full flex flex-col">
                    ...
                    <div className="flex-1 space-y-1">
                      {dayAppointments.slice(0, 2).map((apt) => (
                        <div
                          key={apt.id}
                          className={`text-xs px-1 py-0.5 rounded text-white truncate cursor-pointer hover:opacity-80 transition-opacity ${getStatusColor(
                            apt.status
                          )}`}
                          title={`${formatTime(apt.date)} - ${
                            apt.customer.name
                          }`}
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <CardTitle className="text-base">
                        <Button
                          variant="link"
                          className="h-auto p-0 font-semibold text-gray-900 hover:text-indigo-600"
                          onClick={() =>
        ...
        <div className="bg-gray-50 px-6 py-4 border-b">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold text-gray-900">
              ...
              -{" "}
              {weekDates[6].toLocaleDateString("es-CL", {
                day: "numeric",
                month: "short",
                year: "numeric",
              })}
            ...
            <div className="grid grid-cols-8 border-l border-gray-200">
              ...
              <div className="border-r border-gray-200">
                {timeSlots.map((hour) => (
                  <div
                    key={hour}
                    className="h-16 border-b border-gray-100 flex items-center justify-end pr-3"
                  >
                    <span className="text-xs text-gray-500">
                    ...
                    return (
                      ...
                      >
                        {hourAppointments.map((apt) => (
                          <div
                            key={apt.id}
                            className={`text-xs px-2 py-1 rounded mb-1 text-white cursor-pointer hover:opacity-80 ${getStatusColor(
                              apt.status
                            )}`}
                            onClick={() =>
                            ...
                            title={`${apt.customer.name} - ${formatTime(
                              apt.date
                            )}`}
                          >
              ...
              <div className="flex-1">
                {timeSlots.map((hour) => {
                  ...
                  return (
                    <div
                      key={hour}
                      className="h-16 border-b border-gray-100 p-2 relative"
                    >
                      {hourAppointments.map((apt) => (
                        <div
                          key={apt.id}
          ...
          <div className="flex items-center space-x-4">
            ...
            <h2 className="text-xl font-semibold text-gray-900">
              ...
              {viewMode === "week" &&
                (() => {
                  const weekDates = getWeekDates(currentDate);
                  return `${weekDates[0].toLocaleDateString("es-CL", {
                    day: "numeric",
                    month: "short",
                  })} - ${weekDates[6].toLocaleDateString("es-CL", {
                    day: "numeric",
        ...
        {loading ? (
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div>{renderSelectedDateDetails()}</div>
            </div>
          </div>
        )}
      </div>
